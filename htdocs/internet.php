...
<? require_once("templets/navbar.php"); ?>
    <div class="container">
        ...
        <div id="cluster-menu" class="cluster-menu">
            ...
            <div id="cluster-menu-option-internet" class="cluster-menu-option-selected">Internet</div>
            <div class="cluster-menu-option-edge"></div>
        </div>
        <div id="content" class="content">
            <div class="browser">
                <div class="browser-bar">
                    <center>
                        <form>
                            IP address: <input class="search-bar" name="ip" type="text" value="1.1.1.1">
                            <input class="button-normal" type="submit" value="Connect">
                        </form>
                    </center>
                </div>
                <div id="internet-menu" class="internet-menu">
                    <div class="internet-menu-option-edge"></div>
                    <div id="internet-menu-option-hardware" class="internet-menu-option">Log</div>
                    <div id="internet-menu-option-software" class="internet-menu-option">Software</div>
                    <div id="internet-menu-option-processes" class="internet-menu-option">Logout</div>
                    <div class="internet-menu-option-edge"></div>
                </div>
            </div>
        </div>
