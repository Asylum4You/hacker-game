...
<body>
    ...
    <div class="container">
        ...
        <div id="cluster-menu" class="cluster-menu">
            ...
            <div id="cluster-menu-option-processes" class="cluster-menu-option-selected">Processes</div>
            <div id="cluster-menu-option-internet" class="cluster-menu-option">Internet</div>
            <div class="cluster-menu-option-edge"></div>
        </div>
        <div id="content" class="content">
            <table class="processes">
                <tr class="processes-row">
                    <td class="processes-cell">Processes</td>
                    <td class="processes-cell">Progress</td>
                    <td class="processes-cell">Time Remaining</td>
                    <td class="processes-cell">Actions</td>
                </tr>
                <tr class="processes-row">
                    <td class="processes-cell">Delete file adsf.exp at ff:ff:ff:ff:ff:ff:00:00</td>
                    <td class="processes-cell">100%</td>
                    <td class="processes-cell">0 seconds</td>
                    <td class="processes-cell">
                        <div class="process-cell-action"><img src="res/img/run.png">
                            <div class="cell-action-tooltip-text">Complete</div>
                        </div>
                        <div class="process-cell-action"><img src="res/img/cancel.png">
                            <div class="cell-action-tooltip-text">Cancel</div>
                        </div>
                    </td>
                </tr>
            </table>
